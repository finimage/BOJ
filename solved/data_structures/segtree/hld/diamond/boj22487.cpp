...
ll n, q, arr[200002], parent[200002], dep[200002], stsize[200002], num[200002], revnum[200002], top[200002], lazy[800008], cnt;
info tree[800008];
vector<vector<ll>> g;
...
int main() {
    ...
    while (q--) {
        cin >> a >> b >> c >> d;
        if (a == 2) cout << res_path(b, c) << '\n';
        else update_path(b, c, d);
    }
}
